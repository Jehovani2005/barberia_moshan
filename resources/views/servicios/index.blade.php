        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th class="texto-tabla">Nombre del Servicio</th>
                    <th class="texto-tabla">Descripción</th>
                    <th class="texto-tabla">Duración</th>
                    <th class="texto-tabla">Precio</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="texto-tabla">{{ $servi->nombre }}</td>
                    <td class="texto-tabla">{{ $servi->descripcion }}</td>
                    <td class="texto-tabla">{{ $servi->duracion }} min</td>
                    <td class="texto-tabla">${{ $servi->precio }}</td>
